...
const ADC_CONFIG_STRUCT ADC_allConfigs[ADC_TOTAL_CONFIGS] = {
	/*Configuration 0*/
	{
		...
		ADC_CFG0_FILTERSTARTDELAY,
		ADC_CFG0_HALF_A_CA_VAL,
		ADC_CFG0_HALF_A_CB_VAL,
		ADC_CFG0_HALF_A_CC_VAL,
		ADC_CFG0_HALF_A_CF_VAL,
		ADC_CFG0_HALF_B_CA_VAL,
		ADC_CFG0_HALF_B_CB_VAL,
		ADC_CFG0_HALF_B_CC_VAL,
		ADC_CFG0_HALF_B_CF_VAL,
		ADC_CFG0_HALF_A_SW_TB,
		ADC_CFG0_HALF_B_SW_TB,
		ADC_CFG0_HALF_B_SW_TC,
		ADC_CFG0_HALF_A_CB_GND,
		ADC_CFG0_HALF_B_CB_GND,
		ADC_CFG0_HALF_B_CC_GND,
#endif
	}
	...
	,{
		...
		ADC_CFG1_FILTERSTARTDELAY,
		ADC_CFG1_HALF_A_CA_VAL,
		ADC_CFG1_HALF_A_CB_VAL,
		ADC_CFG1_HALF_A_CC_VAL,
		ADC_CFG1_HALF_A_CF_VAL,
		ADC_CFG1_HALF_B_CA_VAL,
		ADC_CFG1_HALF_B_CB_VAL,
		ADC_CFG1_HALF_B_CC_VAL,
		ADC_CFG1_HALF_B_CF_VAL,
		ADC_CFG1_HALF_A_SW_TB,
		ADC_CFG1_HALF_B_SW_TB,
		ADC_CFG1_HALF_B_SW_TC,
		ADC_CFG1_HALF_A_CB_GND,
		ADC_CFG1_HALF_B_CB_GND,
		ADC_CFG1_HALF_B_CC_GND,
#endif
	}
	#endif
	...
	,{
		...
		ADC_CFG2_FILTERSTARTDELAY,
		ADC_CFG2_HALF_A_CA_VAL,
		ADC_CFG2_HALF_A_CB_VAL,
		ADC_CFG2_HALF_A_CC_VAL,
		ADC_CFG2_HALF_A_CF_VAL,
		ADC_CFG2_HALF_B_CA_VAL,
		ADC_CFG2_HALF_B_CB_VAL,
		ADC_CFG2_HALF_B_CC_VAL,
		ADC_CFG2_HALF_B_CF_VAL,
		ADC_CFG2_HALF_A_SW_TB,
		ADC_CFG2_HALF_B_SW_TB,
		ADC_CFG2_HALF_B_SW_TC,
		ADC_CFG2_HALF_A_CB_GND,
		ADC_CFG2_HALF_B_CB_GND,
		ADC_CFG2_HALF_B_CC_GND,
#endif
	}
	#endif
	/*Configuration 3*/
	...
	,{
		...
		ADC_CFG3_FILTERSTARTDELAY,
		ADC_CFG3_HALF_A_CA_VAL,
		ADC_CFG3_HALF_A_CB_VAL,
		ADC_CFG3_HALF_A_CC_VAL,
		ADC_CFG3_HALF_A_CF_VAL,
		ADC_CFG3_HALF_B_CA_VAL,
		ADC_CFG3_HALF_B_CB_VAL,
		ADC_CFG3_HALF_B_CC_VAL,
		ADC_CFG3_HALF_B_CF_VAL,
		ADC_CFG3_HALF_A_SW_TB,
		ADC_CFG3_HALF_B_SW_TB,
		ADC_CFG3_HALF_B_SW_TC,
		ADC_CFG3_HALF_A_CB_GND,
		ADC_CFG3_HALF_B_CB_GND,
		ADC_CFG3_HALF_B_CC_GND,
#endif
	}
	#endif	
};
