// ======================================================================
// EnvironmentSensing.v generated from TopDesign.cysch
// 02/01/2017 at 19:16
...
// PVref_P4_v1_0(RefSource=0, SelOutputVoltage=16, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=PVref_P4_v1_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PVref, CY_INSTANCE_SHORT_NAME=PVref, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=PVref, )
module PVref_P4_v1_0_0 (
    Vout);
    inout       Vout;
    electrical  Vout;
...
// Scan_ADC_v1_10(AclkMuxSelect=0, Config0=<?xml version="1.0" encoding="utf-16"?><CyConfigModel xmlns:Version="1_0"><SampleRateEditor>true</SampleRateEditor><SampleRate>2000</SampleRate><FreeRunning>true</FreeRunning><UseSoc>false</UseSoc><VrefBypass>false</VrefBypass><VrefSource>VREFSOURCE_VBGR</VrefSource><VrefVoltage>1.2</VrefVoltage><VnegSource>VNEGSOURCE_VREFSHORT</VnegSource><DiffResultFormat>SIGNED_FORMAT</DiffResultFormat><SingleEndedResultFormat>UNSIGNED_FORMAT</SingleEndedResultFormat><SamplesAveraged>SIXTYFOUR_SAMPLES</SamplesAveraged><AveragingMode>SEQUENTIAL_AVG</AveragingMode><AlternateResolution>EIGHT_BIT</AlternateResolution><CompareMode>LESS_THAN</CompareMode><LowLimit>512</LowLimit><HighLimit>3584</HighLimit><NumChannels>7</NumChannels><ChannelList><CyChannelModel><Enabled>true</Enabled><UseAltResolution>false</UseAltResolution><InputMode>SINGLE_ENDED_CHAN</InputMode><UseAveraging>true</UseAveraging><MinimumAcqTime>1000</MinimumAcqTime><UseLimitInterrupt>false</UseLimitInterrupt><ActualAcqTime>1500</ActualAcqTime><UseSaturationInterrupt>false</UseSaturationInterrupt><ApertureTimer>0</ApertureTimer></CyChannelModel><CyChannelModel><Enabled>true</Enabled><UseAltResolution>false</UseAltResolution><InputMode>SINGLE_ENDED_CHAN</InputMode><UseAveraging>true</UseAveraging><MinimumAcqTime>1000</MinimumAcqTime><UseLimitInterrupt>false</UseLimitInterrupt><ActualAcqTime>1500</ActualAcqTime><UseSaturationInterrupt>false</UseSaturationInterrupt><ApertureTimer>1</ApertureTimer></CyChannelModel><CyChannelModel><Enabled>true</Enabled><UseAltResolution>false</UseAltResolution><InputMode>SINGLE_ENDED_CHAN</InputMode><UseAveraging>true</UseAveraging><MinimumAcqTime>1000</MinimumAcqTime><UseLimitInterrupt>false</UseLimitInterrupt><ActualAcqTime>1500</ActualAcqTime><UseSaturationInterrupt>false</UseSaturationInterrupt><ApertureTimer>1</ApertureTimer></CyChannelModel><CyChannelModel><Enabled>true</Enabled><UseAltResolution>false</UseAltResolution><InputMode>DIFFERENTIAL_CHAN</InputMode><UseAveraging>true</UseAveraging><MinimumAcqTime>1000</MinimumAcqTime><UseLimitInterrupt>false</UseLimitInterrupt><ActualAcqTime>1500</ActualAcqTime><UseSaturationInterrupt>false</UseSaturationInterrupt><ApertureTimer>1</ApertureTimer></CyChannelModel><CyChannelModel><Enabled>true</Enabled><UseAltResolution>false</UseAltResolution><InputMode>DIFFERENTIAL_CHAN</InputMode><UseAveraging>true</UseAveraging><MinimumAcqTime>1000</MinimumAcqTime><UseLimitInterrupt>false</UseLimitInterrupt><ActualAcqTime>1500</ActualAcqTime><UseSaturationInterrupt>false</UseSaturationInterrupt><ApertureTimer>1</ApertureTimer></CyChannelModel><CyChannelModel><Enabled>true</Enabled><UseAltResolution>false</UseAltResolution><InputMode>SINGLE_ENDED_CHAN</InputMode><UseAveraging>true</UseAveraging><MinimumAcqTime>1000</MinimumAcqTime><UseLimitInterrupt>false</UseLimitInterrupt><ActualAcqTime>1500</ActualAcqTime><UseSaturationInterrupt>false</UseSaturationInterrupt><ApertureTimer>1</ApertureTimer></CyChannelModel><CyChannelModel><Enabled>true</Enabled><UseAltResolution>false</UseAltResolution><InputMode>SINGLE_ENDED_CHAN</InputMode><UseAveraging>true</UseAveraging><MinimumAcqTime>1000</MinimumAcqTime><UseLimitInterrupt>false</UseLimitInterrupt><ActualAcqTime>1500</ActualAcqTime><UseSaturationInterrupt>false</UseSaturationInterrupt><ApertureTimer>1</ApertureTimer></CyChannelModel></ChannelList><ApertureTimers><int>3</int><int>3</int><int>2</int><int>2</int></ApertureTimers><AdcClockDivider>24</AdcClockDivider><FilterType>LOW_PASS</FilterType><FilterDown3OrCenter>100</FilterDown3OrCenter><FilterWidthOrNotch>300</FilterWidthOrNotch><FilterSample>1000</FilterSample><FilterUabStartDelay>0</FilterUabStartDelay><FilterUabClockDivider>0</FilterUabClockDivider><UabCaps><Gain>0</Gain><C1>0</C1><C2>0</C2><C3>0</C3><C4>0</C4><CA>0</CA><CB>0</CB><CP>0</CP><CPP>0</CPP><CPPP>0</CPPP></UabCaps><ActualSampleRate>263</ActualSampleRate><ActualAdcClockHz>2000000</ActualAdcClockHz><ActualScanNs>3802281</ActualScanNs></CyConfigModel>, Config1=<?xml version="1.0" encoding="utf-16"?><CyConfigModel xmlns:Version="1_0"><SampleRateEditor>true</SampleRateEditor><SampleRate>5000</SampleRate><FreeRunning>true</FreeRunning><UseSoc>false</UseSoc><VrefBypass>false</VrefBypass><VrefSource>VREFSOURCE_HALFVDDA</VrefSource><VrefVoltage>1.65</VrefVoltage><VnegSource>VNEGSOURCE_EXTERNAL</VnegSource><DiffResultFormat>SIGNED_FORMAT</DiffResultFormat><SingleEndedResultFormat>UNSIGNED_FORMAT</SingleEndedResultFormat><SamplesAveraged>TWO_SAMPLES</SamplesAveraged><AveragingMode>SEQUENTIAL_AVG</AveragingMode><AlternateResolution>EIGHT_BIT</AlternateResolution><CompareMode>LESS_THAN</CompareMode><LowLimit>512</LowLimit><HighLimit>3584</HighLimit><NumChannels>2</NumChannels><ChannelList><CyChannelModel><Enabled>true</Enabled><UseAltResolution>false</UseAltResolution><InputMode>DIFFERENTIAL_CHAN</InputMode><UseAveraging>false</UseAveraging><MinimumAcqTime>194</MinimumAcqTime><UseLimitInterrupt>false</UseLimitInterrupt><ActualAcqTime>185000</ActualAcqTime><UseSaturationInterrupt>false</UseSaturationInterrupt><ApertureTimer>0</ApertureTimer></CyChannelModel><CyChannelModel><Enabled>true</Enabled><UseAltResolution>false</UseAltResolution><InputMode>DIFFERENTIAL_CHAN</InputMode><UseAveraging>false</UseAveraging><MinimumAcqTime>194</MinimumAcqTime><UseLimitInterrupt>false</UseLimitInterrupt><ActualAcqTime>1000</ActualAcqTime><UseSaturationInterrupt>false</UseSaturationInterrupt><ApertureTimer>1</ApertureTimer></CyChannelModel></ChannelList><ApertureTimers><int>370</int><int>2</int><int>2</int><int>2</int></ApertureTimers><AdcClockDivider>24</AdcClockDivider><FilterType>LOW_PASS</FilterType><FilterDown3OrCenter>10</FilterDown3OrCenter><FilterWidthOrNotch>500</FilterWidthOrNotch><FilterSample>1000</FilterSample><FilterUabStartDelay>0</FilterUabStartDelay><FilterUabClockDivider>0</FilterUabClockDivider><UabCaps><Gain>0</Gain><C1>0</C1><C2>0</C2><C3>0</C3><C4>0</C4><CA>0</CA><CB>0</CB><CP>0</CP><CPP>0</CPP><CPPP>0</CPPP></UabCaps><ActualSampleRate>5000</ActualSampleRate><ActualAdcClockHz>2000000</ActualAdcClockHz><ActualScanNs>200000</ActualScanNs></CyConfigModel>, Config2=<?xml version="1.0" encoding="utf-16"?><CyConfigModel xmlns:Version="1_0"><SampleRateEditor>true</SampleRateEditor><SampleRate>5000</SampleRate><FreeRunning>true</FreeRunning><UseSoc>false</UseSoc><VrefBypass>false</VrefBypass><VrefSource>VREFSOURCE_HALFVDDA</VrefSource><VrefVoltage>1.65</VrefVoltage><VnegSource>VNEGSOURCE_EXTERNAL</VnegSource><DiffResultFormat>SIGNED_FORMAT</DiffResultFormat><SingleEndedResultFormat>UNSIGNED_FORMAT</SingleEndedResultFormat><SamplesAveraged>TWO_SAMPLES</SamplesAveraged><AveragingMode>SEQUENTIAL_AVG</AveragingMode><AlternateResolution>EIGHT_BIT</AlternateResolution><CompareMode>LESS_THAN</CompareMode><LowLimit>512</LowLimit><HighLimit>3584</HighLimit><NumChannels>2</NumChannels><ChannelList><CyChannelModel><Enabled>true</Enabled><UseAltResolution>false</UseAltResolution><InputMode>DIFFERENTIAL_CHAN</InputMode><UseAveraging>false</UseAveraging><MinimumAcqTime>194</MinimumAcqTime><UseLimitInterrupt>false</UseLimitInterrupt><ActualAcqTime>185000</ActualAcqTime><UseSaturationInterrupt>false</UseSaturationInterrupt><ApertureTimer>0</ApertureTimer></CyChannelModel><CyChannelModel><Enabled>true</Enabled><UseAltResolution>false</UseAltResolution><InputMode>DIFFERENTIAL_CHAN</InputMode><UseAveraging>false</UseAveraging><MinimumAcqTime>194</MinimumAcqTime><UseLimitInterrupt>false</UseLimitInterrupt><ActualAcqTime>1000</ActualAcqTime><UseSaturationInterrupt>false</UseSaturationInterrupt><ApertureTimer>1</ApertureTimer></CyChannelModel></ChannelList><ApertureTimers><int>370</int><int>2</int><int>2</int><int>2</int></ApertureTimers><AdcClockDivider>24</AdcClockDivider><FilterType>LOW_PASS</FilterType><FilterDown3OrCenter>10</FilterDown3OrCenter><FilterWidthOrNotch>500</FilterWidthOrNotch><FilterSample>1000</FilterSample><FilterUabStartDelay>0</FilterUabStartDelay><FilterUabClockDivider>0</FilterUabClockDivider><UabCaps><Gain>0</Gain><C1>0</C1><C2>0</C2><C3>0</C3><C4>0</C4><CA>0</CA><CB>0</CB><CP>0</CP><CPP>0</CPP><CPPP>0</CPPP></UabCaps><ActualSampleRate>5000</ActualSampleRate><ActualAdcClockHz>2000000</ActualAdcClockHz><ActualScanNs>200000</ActualScanNs></CyConfigModel>, Config3=<?xml version="1.0" encoding="utf-16"?><CyConfigModel xmlns:Version="1_0"><SampleRateEditor>true</SampleRateEditor><SampleRate>5000</SampleRate><FreeRunning>true</FreeRunning><UseSoc>false</UseSoc><VrefBypass>false</VrefBypass><VrefSource>VREFSOURCE_HALFVDDA</VrefSource><VrefVoltage>1.65</VrefVoltage><VnegSource>VNEGSOURCE_EXTERNAL</VnegSource><DiffResultFormat>SIGNED_FORMAT</DiffResultFormat><SingleEndedResultFormat>UNSIGNED_FORMAT</SingleEndedResultFormat><SamplesAveraged>TWO_SAMPLES</SamplesAveraged><AveragingMode>SEQUENTIAL_AVG</AveragingMode><AlternateResolution>EIGHT_BIT</AlternateResolution><CompareMode>LESS_THAN</CompareMode><LowLimit>512</LowLimit><HighLimit>3584</HighLimit><NumChannels>2</NumChannels><ChannelList><CyChannelModel><Enabled>true</Enabled><UseAltResolution>false</UseAltResolution><InputMode>DIFFERENTIAL_CHAN</InputMode><UseAveraging>false</UseAveraging><MinimumAcqTime>194</MinimumAcqTime><UseLimitInterrupt>false</UseLimitInterrupt><ActualAcqTime>185000</ActualAcqTime><UseSaturationInterrupt>false</UseSaturationInterrupt><ApertureTimer>0</ApertureTimer></CyChannelModel><CyChannelModel><Enabled>true</Enabled><UseAltResolution>false</UseAltResolution><InputMode>DIFFERENTIAL_CHAN</InputMode><UseAveraging>false</UseAveraging><MinimumAcqTime>194</MinimumAcqTime><UseLimitInterrupt>false</UseLimitInterrupt><ActualAcqTime>1000</ActualAcqTime><UseSaturationInterrupt>false</UseSaturationInterrupt><ApertureTimer>1</ApertureTimer></CyChannelModel></ChannelList><ApertureTimers><int>370</int><int>2</int><int>2</int><int>2</int></ApertureTimers><AdcClockDivider>24</AdcClockDivider><FilterType>LOW_PASS</FilterType><FilterDown3OrCenter>10</FilterDown3OrCenter><FilterWidthOrNotch>500</FilterWidthOrNotch><FilterSample>1000</FilterSample><FilterUabStartDelay>0</FilterUabStartDelay><FilterUabClockDivider>0</FilterUabClockDivider><UabCaps><Gain>0</Gain><C1>0</C1><C2>0</C2><C3>0</C3><C4>0</C4><CA>0</CA><CB>0</CB><CP>0</CP><CPP>0</CPP><CPPP>0</CPPP></UabCaps><ActualSampleRate>5000</ActualSampleRate><ActualAdcClockHz>2000000</ActualAdcClockHz><ActualScanNs>200000</ActualScanNs></CyConfigModel>, Debug=false, ExternalClk=true, ExternalSoc=false, ExtVrefMuxSelect=2, FilterConfigMuxSelect_0=1, FilterConfigMuxSelect_1=1, FilterConfigMuxSelect_2=2, FilterConfigMuxSelect_3=3, FilterVinMuxSelect_1_0=6, FilterVinMuxSelect_2_0=5, FilterVinMuxSelect_2_1=0, FilterVinMuxSelect_3_0=4, FilterVinMuxSelect_3_1=0, FilterVinMuxSelect_3_2=0, IsFilterPresent=false, NumConfigs=1, SarmuxDiffMask=0001100, SarmuxVinDiffWidth=7, SarmuxVinNegWidth=1, SarmuxVinPlusMuxSelect_0=0, SarmuxVinPlusMuxSelect_1=0, SarmuxVinPlusMuxSelect_10=0, SarmuxVinPlusMuxSelect_11=0, SarmuxVinPlusMuxSelect_12=0, SarmuxVinPlusMuxSelect_13=0, SarmuxVinPlusMuxSelect_14=0, SarmuxVinPlusMuxSelect_15=0, SarmuxVinPlusMuxSelect_16=0, SarmuxVinPlusMuxSelect_17=0, SarmuxVinPlusMuxSelect_18=0, SarmuxVinPlusMuxSelect_19=0, SarmuxVinPlusMuxSelect_2=0, SarmuxVinPlusMuxSelect_20=0, SarmuxVinPlusMuxSelect_21=0, SarmuxVinPlusMuxSelect_22=0, SarmuxVinPlusMuxSelect_23=0, SarmuxVinPlusMuxSelect_24=0, SarmuxVinPlusMuxSelect_25=0, SarmuxVinPlusMuxSelect_26=0, SarmuxVinPlusMuxSelect_27=0, SarmuxVinPlusMuxSelect_28=0, SarmuxVinPlusMuxSelect_29=0, SarmuxVinPlusMuxSelect_3=0, SarmuxVinPlusMuxSelect_30=0, SarmuxVinPlusMuxSelect_31=0, SarmuxVinPlusMuxSelect_32=0, SarmuxVinPlusMuxSelect_33=0, SarmuxVinPlusMuxSelect_34=0, SarmuxVinPlusMuxSelect_35=0, SarmuxVinPlusMuxSelect_36=0, SarmuxVinPlusMuxSelect_37=0, SarmuxVinPlusMuxSelect_38=0, SarmuxVinPlusMuxSelect_39=0, SarmuxVinPlusMuxSelect_4=0, SarmuxVinPlusMuxSelect_40=0, SarmuxVinPlusMuxSelect_41=0, SarmuxVinPlusMuxSelect_42=0, SarmuxVinPlusMuxSelect_43=0, SarmuxVinPlusMuxSelect_44=0, SarmuxVinPlusMuxSelect_45=0, SarmuxVinPlusMuxSelect_46=0, SarmuxVinPlusMuxSelect_47=0, SarmuxVinPlusMuxSelect_48=0, SarmuxVinPlusMuxSelect_49=0, SarmuxVinPlusMuxSelect_5=0, SarmuxVinPlusMuxSelect_50=0, SarmuxVinPlusMuxSelect_51=0, SarmuxVinPlusMuxSelect_52=0, SarmuxVinPlusMuxSelect_53=0, SarmuxVinPlusMuxSelect_54=0, SarmuxVinPlusMuxSelect_55=0, SarmuxVinPlusMuxSelect_56=0, SarmuxVinPlusMuxSelect_57=0, SarmuxVinPlusMuxSelect_58=0, SarmuxVinPlusMuxSelect_59=0, SarmuxVinPlusMuxSelect_6=0, SarmuxVinPlusMuxSelect_60=0, SarmuxVinPlusMuxSelect_61=0, SarmuxVinPlusMuxSelect_62=0, SarmuxVinPlusMuxSelect_63=0, SarmuxVinPlusMuxSelect_7=0, SarmuxVinPlusMuxSelect_8=0, SarmuxVinPlusMuxSelect_9=0, SocMuxSelect=1, Test_ConfigSpacing=15, Test_ExposeTestTerminals=false, UABH_A_AGND_PWR=7, UABH_A_CA_BOOST=1, UABH_A_CB_BOOST=1, UABH_A_CC_BOOST=1, UABH_A_CF_BOOST=1, UABH_A_LAST_STEP=1, UABH_A_OA_PWR=7, UABH_A_PUMP_WAVE=1, UABH_A_SUM_BOOST=1, UABH_A_SW_AGND_TIED=15, UABH_A_SW_AQ=15, UABH_A_SW_BG_MODBIT=2, UABH_A_SW_BQ=1, UABH_A_SW_CX0_MODBIT=15, UABH_A_SW_GB_MODBIT=2, UABH_A_SW_GG=1, UABH_A_SW_PF=15, UABH_A_SW_SA=15, UABH_A_SW_SB=1, UABH_A_SW_SC=15, UABH_A_SW_TC=15, UABH_A_TRIG_SEL=31, UABH_A_TRIGGER_EN=true, UABH_A_WAVE_STEP_0=1, UABH_A_WAVE_STEP_1=2, UABH_B_CA_BOOST=1, UABH_B_CB_BOOST=1, UABH_B_CC_BOOST=1, UABH_B_CF_BOOST=1, UABH_B_LAST_STEP=1, UABH_B_OA_PWR=7, UABH_B_PUMP_WAVE=1, UABH_B_SUM_BOOST=1, UABH_B_SW_AG_MODBIT=2, UABH_B_SW_AGND_TIED=15, UABH_B_SW_AP=0, UABH_B_SW_AQ=1, UABH_B_SW_BX0_MODBIT=15, UABH_B_SW_CG_MODBIT=2, UABH_B_SW_CX0_MODBIT=1, UABH_B_SW_GA_MODBIT=1, UABH_B_SW_GC_MODBIT=2, UABH_B_SW_GG=1, UABH_B_SW_PF=15, UABH_B_SW_PO=1, UABH_B_SW_SA=2, UABH_B_SW_SB=15, UABH_B_SW_ZC=1, UABH_B_TRIG_SEL=0, UABH_B_TRIGGER_EN=true, UABH_B_VALID_WAVE=1, UABH_B_WAVE_STEP_0=1, UABH_B_WAVE_STEP_1=2, UABH_B_WAVE_STEP_2=2, UABH_B_WAVE_STEP_3=2, UABH_B_WAVE_STEP_4=2, UABH_B_WAVE_STEP_5=2, UABH_B_WAVE_STEP_6=2, UABH_B_WAVE_STEP_7=2, VinMinusMuxSelect_0=1, VinMinusMuxSelect_1=1, VinMinusMuxSelect_10=1, VinMinusMuxSelect_11=1, VinMinusMuxSelect_12=1, VinMinusMuxSelect_13=1, VinMinusMuxSelect_14=1, VinMinusMuxSelect_15=1, VinMinusMuxSelect_16=1, VinMinusMuxSelect_17=1, VinMinusMuxSelect_18=1, VinMinusMuxSelect_19=1, VinMinusMuxSelect_2=1, VinMinusMuxSelect_20=1, VinMinusMuxSelect_21=1, VinMinusMuxSelect_22=1, VinMinusMuxSelect_23=1, VinMinusMuxSelect_24=1, VinMinusMuxSelect_25=1, VinMinusMuxSelect_26=1, VinMinusMuxSelect_27=1, VinMinusMuxSelect_28=1, VinMinusMuxSelect_29=1, VinMinusMuxSelect_3=0, VinMinusMuxSelect_30=1, VinMinusMuxSelect_31=1, VinMinusMuxSelect_32=1, VinMinusMuxSelect_33=1, VinMinusMuxSelect_34=1, VinMinusMuxSelect_35=1, VinMinusMuxSelect_36=1, VinMinusMuxSelect_37=1, VinMinusMuxSelect_38=1, VinMinusMuxSelect_39=1, VinMinusMuxSelect_4=0, VinMinusMuxSelect_40=1, VinMinusMuxSelect_41=1, VinMinusMuxSelect_42=1, VinMinusMuxSelect_43=1, VinMinusMuxSelect_44=1, VinMinusMuxSelect_45=1, VinMinusMuxSelect_46=1, VinMinusMuxSelect_47=1, VinMinusMuxSelect_48=1, VinMinusMuxSelect_49=1, VinMinusMuxSelect_5=1, VinMinusMuxSelect_50=1, VinMinusMuxSelect_51=1, VinMinusMuxSelect_52=1, VinMinusMuxSelect_53=1, VinMinusMuxSelect_54=1, VinMinusMuxSelect_55=1, VinMinusMuxSelect_56=1, VinMinusMuxSelect_57=1, VinMinusMuxSelect_58=1, VinMinusMuxSelect_59=1, VinMinusMuxSelect_6=1, VinMinusMuxSelect_60=1, VinMinusMuxSelect_61=1, VinMinusMuxSelect_62=1, VinMinusMuxSelect_63=1, VinMinusMuxSelect_7=1, VinMinusMuxSelect_8=1, VinMinusMuxSelect_9=1, VinNegMuxSelect_0=1, VinNegMuxSelect_1=1, VinNegMuxSelect_2=1, VinNegMuxSelect_3=1, VinPlusMuxSelect_0=0, VinPlusMuxSelect_1=0, VinPlusMuxSelect_10=1, VinPlusMuxSelect_11=1, VinPlusMuxSelect_12=1, VinPlusMuxSelect_13=1, VinPlusMuxSelect_14=1, VinPlusMuxSelect_15=1, VinPlusMuxSelect_16=1, VinPlusMuxSelect_17=1, VinPlusMuxSelect_18=1, VinPlusMuxSelect_19=1, VinPlusMuxSelect_2=0, VinPlusMuxSelect_20=1, VinPlusMuxSelect_21=1, VinPlusMuxSelect_22=1, VinPlusMuxSelect_23=1, VinPlusMuxSelect_24=1, VinPlusMuxSelect_25=1, VinPlusMuxSelect_26=1, VinPlusMuxSelect_27=1, VinPlusMuxSelect_28=1, VinPlusMuxSelect_29=1, VinPlusMuxSelect_3=0, VinPlusMuxSelect_30=1, VinPlusMuxSelect_31=1, VinPlusMuxSelect_32=1, VinPlusMuxSelect_33=1, VinPlusMuxSelect_34=1, VinPlusMuxSelect_35=1, VinPlusMuxSelect_36=1, VinPlusMuxSelect_37=1, VinPlusMuxSelect_38=1, VinPlusMuxSelect_39=1, VinPlusMuxSelect_4=0, VinPlusMuxSelect_40=1, VinPlusMuxSelect_41=1, VinPlusMuxSelect_42=1, VinPlusMuxSelect_43=1, VinPlusMuxSelect_44=1, VinPlusMuxSelect_45=1, VinPlusMuxSelect_46=1, VinPlusMuxSelect_47=1, VinPlusMuxSelect_48=1, VinPlusMuxSelect_49=1, VinPlusMuxSelect_5=0, VinPlusMuxSelect_50=1, VinPlusMuxSelect_51=1, VinPlusMuxSelect_52=1, VinPlusMuxSelect_53=1, VinPlusMuxSelect_54=1, VinPlusMuxSelect_55=1, VinPlusMuxSelect_56=1, VinPlusMuxSelect_57=1, VinPlusMuxSelect_58=1, VinPlusMuxSelect_59=1, VinPlusMuxSelect_6=0, VinPlusMuxSelect_60=1, VinPlusMuxSelect_61=1, VinPlusMuxSelect_62=1, VinPlusMuxSelect_63=1, VinPlusMuxSelect_7=1, VinPlusMuxSelect_8=1, VinPlusMuxSelect_9=1, VminusMuxSelect=0, VplusMuxSelect=0, VrefMuxSelect_0=1, VrefMuxSelect_1=1, VrefMuxSelect_2=1, VrefMuxSelect_3=1, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=Scan_ADC_v1_10, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ADC, CY_INSTANCE_SHORT_NAME=ADC, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=10, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=ADC, )
module Scan_ADC_v1_10_1 (
    vinPlus_6,
    vinPlus_5,
    vinMinus_4,
    vinPlus_4,
    ...
    inout       vinMinus_4;
    electrical  vinMinus_4;
    inout       vinPlus_4;
    electrical  vinPlus_4;
    inout       vinMinus_3;
    electrical  vinMinus_3;
    inout       vinPlus_3;
    ...
    electrical [6:0] Net_340;
    electrical [6:0] Net_339;
    electrical  Net_316;
    electrical  Net_315;
    electrical  Net_314;
    electrical  Net_313;
	...
	cy_connect_v1_0 vinMinusMux_3_connect(vinMinus[3], vinMinus_3);
	...
	cy_connect_v1_0 vinMinusMux_4_connect(vinMinus[4], vinMinus_4);
    ...
    defparam vinMinusConnect.out_width = 7;

    cy_psoc4_sarmux_v1_10 cy_psoc4_sarmux_1 (
        .muxin_plus(Net_339[6:0]),
        .muxin_minus(Net_340[6:0]),
        .cmn_neg(Net_365[0:0]),
        .vout_plus(sarmuxOutPlus),
        .vout_minus(sarmuxOutMinus));
    defparam cy_psoc4_sarmux_1.cmn_neg_width = 1;
    defparam cy_psoc4_sarmux_1.input_mode = "0001100";
    defparam cy_psoc4_sarmux_1.muxin_width = 7;
    ...
    assign Net_448 = Net_428 | Net_446;
	...
	cy_connect_v1_0 filterVinMux_3_0_connect(Net_1146, vinPlus[7]);
	...
	cy_connect_v1_0 filterVinMux_2_0_connect(Net_1142, vinPlus[7]);
	defparam filterVinMux_2_0_connect.sig_width = 1;

	// filterVinMux_1_0 (cy_analog_virtualmux_v1_0)
	cy_connect_v1_0 filterVinMux_1_0_connect(Net_1136, vinPlus[7]);
	...
	cy_clock_v1_0
		#(.id("6f1c2485-e710-4a22-b73f-1d25b0e2aa8a/b6815a07-3ae4-40f3-8790-63c50500bc89"),
    ...
    cy_analog_noconnect_v1_0 cy_analog_noconnect_79 (
        .noconnect(Net_984));
    ...
    defparam vinPlusConnect.out_width = 7;
...
module SCB_P4_v3_20_2 (
	...
	cy_psoc3_pins_v1_10
		#(.id("94467288-781c-449d-8a00-1eac0c6b2b59/23b8206d-1c77-4e61-be4a-b4037d5de5fc"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("94467288-781c-449d-8a00-1eac0c6b2b59/78e33e5d-45ea-4b75-88d5-73274e8a7ce4"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
// OpAmp_P4_v1_20(Compensation=3, DeepSleepSupport=false, Mode=1, OutputCurrent=1, Power=3, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=OpAmp_P4_v1_20, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=VrefBuffer, CY_INSTANCE_SHORT_NAME=VrefBuffer, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=20, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=VrefBuffer, )
...
// OpAmp_P4_v1_20(Compensation=3, DeepSleepSupport=false, Mode=0, OutputCurrent=1, Power=3, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=OpAmp_P4_v1_20, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PIRAmplifierStage1, CY_INSTANCE_SHORT_NAME=PIRAmplifierStage1, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=20, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=PIRAmplifierStage1, )
...
// CapSense_P4_v3_0(AdcAmuxbInputEnable=false, AdcAzEnable=false, AdcAzTime=10, AdcDedicatedChannels=1, AdcEnable=false, AdcPinAlias=Ch0, AdcResolution=10, AdcSelectAmuxBusChannel=0, AdcTotalChannels=1, AdcVref=-1, BaselineType=0, BlockOffAfterScanEnable=false, Csd0IdacGainV1=4, Csd0IdacGainV2=2, Csd0PinAlias=Button0_Sns0, Button0_Sns1, Csd0PinCount=2, Csd0ShieldDelayV1=0, Csd0ShieldDelayV2=0, Csd0ShieldEnable=false, Csd0ShieldPrechargeSource=0, Csd0ShieldTankEnable=false, Csd0TotalShieldCount=1, Csd1IdacGainV1=4, Csd1IdacGainV2=2, Csd1PinAlias=, Csd1PinCount=0, Csd1ShieldDelayV1=0, Csd1ShieldDelayV2=0, Csd1ShieldEnable=false, Csd1ShieldPrechargeSource=0, Csd1ShieldTankEnable=false, Csd1TotalShieldCount=1, Csd2xEnable=false, CsdAutoZeroEnable=false, CsdAutoZeroTime=1, CsdCommonSenseClockEnable=false, CsdDedicatedIdacCompEnable=true, CsdDualIdacLevel=50, CsdEnable=true, CsdIdacAutoCalibrateEnable=true, CsdIdacCompEnable=true, CsdIdacConfig=0, CsdInactiveSensorConnection=0, CsdInitSwitchRes=1, CsdModClockFreq=24000, CsdNoiseMetricEnable=false, CsdNoiseMetricThreshold=1, CsdPrescanSettlingTime=5, CsdRawCountCalibrationLevel=85, CsdSenseClockFreq=3000, CsdSenseClockSource=0, CsdShieldSwitchRes=1, CsdSnsClockConstantR=1000, CsdTuningMode=0, CsdVrefV2=-1, Csx0IdacGainV1=4, Csx0IdacGainV2=1, Csx0PinAliasRx=, Csx0PinCountRx=0, Csx1IdacGainV1=4, Csx1IdacGainV2=1, Csx1PinAliasRx=, Csx1PinCountRx=0, Csx2xEnable=false, CsxAutoZeroEnable=false, CsxAutoZeroTime=1, CsxCommonTxClockEnable=false, CsxEnable=false, CsxIdacAutoCalibrateEnable=true, CsxIdacBitsUsedV1=8, CsxIdacBitsUsedV2=7, CsxInitSwitchRes=1, CsxMaxFingers=1, CsxMaxLocalPeaks=5, CsxModClockFreq=48000, CsxMultiphaseTxEnable=false, CsxNoiseMetricEnable=false, CsxNoiseMetricThreshold=1, CsxPinAliasMptx=, CsxPinAliasRx=, CsxPinAliasTx=, CsxPinCountMptx=0, CsxPinCountRx=0, CsxPinCountTx=0, CsxRawCountCalibrationLevel=40, CsxSkipAndOversampleNodes=false, CsxTxClockFreq=300, CsxTxClockSource=1, DataSheetCapSense=CapSense_P4_v3_0.pdf, DataSheetCapSenseAdc=CapSense_P4_ADC_v3_0.pdf, DoxygenMode=false, IsAdcSupported=false, IsCapSenseSupported=true, LowBaselineResetSize=8, MultiFreqScanEnable=false, NumCentroids=1, OffDebounceEnable=false, PosIirFilterCoeff=128, ProxAverageFilterEnable=false, ProxAverageFilterSampleSize=4, ProxCustomFilterEnable=false, ProxIirFilterBaselineN=1, ProxIirFilterBaselineType=2, ProxIirFilterEnable=false, ProxIirFilterRawCountN=128, ProxIirFilterRawCountType=1, ProxMedianFilterEnable=false, RegisterMapSelfTest=false, RegularAverageFilterEnable=false, RegularAverageFilterSampleSize=4, RegularCustomFilterEnable=false, RegularIirFilterBaselineN=1, RegularIirFilterBaselineType=2, RegularIirFilterEnable=true, RegularIirFilterRawCountN=128, RegularIirFilterRawCountType=1, RegularMedianFilterEnable=false, SelfTestEnable=false, SensorAutoResetEnable=false, SensorAutoResetMethod=0, SensorAutoResetSamplesCount=1000, ThresholdSize=16, TouchProxThresholdCoeff=300, TunerLayoutPreferences=, TunerOptionsPreferences=, TunerTouchpadPreferences=, TunerViewPreferences=, TunerWidgetData=, VddaValue=3.3, WidgetData=<?xml version="1.0" encoding="utf-16"?> <WidgetData xmlns:Version="3_0">   <Widget id="Button0" type="Button" mode="CSD" block="CSD0" slot="0">     <Angle>0</Angle>     <Orientation>Normal</Orientation>     <Location>       <X>2147483647</X>       <Y>2147483647</Y>     </Location>     <FlippedX>false</FlippedX>     <FlippedY>false</FlippedY>     <Flipped2D>false</Flipped2D>     <ScaleFactor>1</ScaleFactor>     <Properties>       <Sensitivity>500</Sensitivity>       <Diplexing>false</Diplexing>       <MaxPosition>100</MaxPosition>       <MaxXPosition>100</MaxXPosition>       <MaxYPosition>100</MaxYPosition>       <PositionFilter>None</PositionFilter>       <MultiphaseTx>false</MultiphaseTx>       <SenseClockFreq>187.5</SenseClockFreq>       <RowSenseClockFreq>3000</RowSenseClockFreq>       <TxClockFreq>300</TxClockFreq>       <ScanResolution>_16</ScanResolution>       <NumConversions>100</NumConversions>       <IdacMod>         <Idac0>32</Idac0>         <Idac1>32</Idac1>         <Idac2>32</Idac2>       </IdacMod>       <RowIdacMod>         <Idac0>32</Idac0>         <Idac1>32</Idac1>         <Idac2>32</Idac2>       </RowIdacMod>       <FingerThreshold>100</FingerThreshold>       <ProxTouchThreshold>200</ProxTouchThreshold>       <NoiseThreshold>40</NoiseThreshold>       <NegNoiseThreshold>40</NegNoiseThreshold>       <LowBaselineReset>30</LowBaselineReset>       <BaselineReset>1000</BaselineReset>       <BaselineUpdateThreshold>100</BaselineUpdateThreshold>       <Hysteresis>10</Hysteresis>       <OnDebounce>3</OnDebounce>       <OffDebounce>3</OffDebounce>       <Velocity>150</Velocity>     </Properties>     <Sensors>       <Sensor id="Sns0">         <Properties>           <IdacComp>             <Idac0>32</Idac0>             <Idac1>32</Idac1>             <Idac2>32</Idac2>           </IdacComp>           <Idacs />           <UseDedicatedPin>true</UseDedicatedPin>           <GangedPins />         </Properties>       </Sensor>       <Sensor id="Sns1">         <Properties>           <IdacComp>             <Idac0>32</Idac0>             <Idac1>32</Idac1>             <Idac2>32</Idac2>           </IdacComp>           <Idacs />           <UseDedicatedPin>true</UseDedicatedPin>           <GangedPins />         </Properties>       </Sensor>     </Sensors>   </Widget> </WidgetData>, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=CapSense_P4_v3_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=CapSense_P4_v3_0.pdf, CY_FITTER_NAME=CSD, CY_INSTANCE_SHORT_NAME=CSD, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=CSD, )
module CapSense_P4_v3_0_5 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("288d5225-a95e-4936-a4ad-ee9c659f6800/77715107-f8d5-47e5-a629-0fb83101ac6b"),
	...
	cy_psoc3_pins_v1_10
		#(.id("288d5225-a95e-4936-a4ad-ee9c659f6800/7850aeaf-db25-4eae-b828-015ef596b59e"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    assign Net_146 = Net_1423 | Net_147;
...
// OpAmp_P4_v1_20(Compensation=2, DeepSleepSupport=false, Mode=0, OutputCurrent=1, Power=3, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=OpAmp_P4_v1_20, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Opamp_TIA, CY_INSTANCE_SHORT_NAME=Opamp_TIA, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=20, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=Opamp_TIA, )
...
// UABPRIM_v1_0(AGND_PTS=false, AGND_PWR=7, AGND_TIED=false, ALIGN_MODE=0, CA_BOOST=10, CA_VAL=63, CB_64=false, CB_BOOST=0, CB_GND=false, CB_VAL=0, CC_BOOST=0, CC_GND=false, CC_VAL=0, CC_VAL_UPDATE=false, CF_BOOST=10, CF_VAL=31, CF_VAL_UPDATE=false, CMP_DSI_LEVEL=0, CMP_EDGE=0, CMP_FF=0, CMP_PWR=7, COMP_MASK=false, DAC_MODE=0, DAC_MODE_EN=false, EARLY_PO=false, EARLY_PS=false, FRC_SIGN_BIT=false, LAST_STEP=1, MODBIT0_SRC_SEL=0, MODBIT1_SRC_SEL=0, OA_PWR=7, PUMP_WAVE=10, REF_PTS=false, REF_PWR=7, REF_TIED=false, SIGN_VAL=false, STARTUP_DELAY=22, STRB_RST_EN=0, STRB_RST_SEL=0, STROBE_RST=0, STROBE_SW=15, SUBSAMPLE=0, SUBSAMPLE_INIT=0, SUM_BOOST=10, SW_AA=0, SW_AA_1=0, SW_AG_MODBIT=9, SW_AP=0, SW_AQ=0, SW_AR_MODBIT=0, SW_AV_MODBIT=0, SW_AX0_MODBIT=0, SW_AX1_MODBIT=0, SW_AX2_MODBIT=10, SW_AX3_MODBIT=0, SW_BB=0, SW_BG_MODBIT=0, SW_BP=0, SW_BQ=0, SW_BR_MODBIT=0, SW_BV_MODBIT=0, SW_BX0_MODBIT=0, SW_BX1_MODBIT=0, SW_BX2_MODBIT=0, SW_BX3_MODBIT=0, SW_CC=0, SW_CG_MODBIT=0, SW_CP=0, SW_CQ=0, SW_CR_MODBIT=0, SW_CV_MODBIT=0, SW_CX0_MODBIT=0, SW_CX1_MODBIT=0, SW_CX2_MODBIT=0, SW_CX3_MODBIT=0, SW_GA_MODBIT=1, SW_GB_MODBIT=0, SW_GC_MODBIT=0, SW_GF=9, SW_GG=1, SW_GT=0, SW_GX0=0, SW_GX1=0, SW_GX2=0, SW_GX3=0, SW_PF=10, SW_PO=3, SW_PS=9, SW_QT=0, SW_RA_MODBIT=0, SW_RB_MODBIT=0, SW_RC_MODBIT=0, SW_RG=0, SW_RT=0, SW_SA=10, SW_SB=0, SW_SC=0, SW_TB=0, SW_TC=0, SW_VA_MODBIT=0, SW_VB_MODBIT=0, SW_VC_MODBIT=0, SW_ZC=0, TRIG_OUT=0, TRIG_SEL=31, TRIGGER_EN=true, UAB_PWR=2, VALID_WAVE=15, VDAC_EMPTY_MASK=false, WAVE_STEP_0=2821, WAVE_STEP_1=3590, WAVE_STEP_10=0, WAVE_STEP_11=0, WAVE_STEP_12=0, WAVE_STEP_13=0, WAVE_STEP_14=0, WAVE_STEP_15=0, WAVE_STEP_2=0, WAVE_STEP_3=0, WAVE_STEP_4=0, WAVE_STEP_5=0, WAVE_STEP_6=0, WAVE_STEP_7=0, WAVE_STEP_8=0, WAVE_STEP_9=0, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=UABPRIM_v1_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Rectifier:UABH_B, CY_INSTANCE_SHORT_NAME=UABH_B, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=Rectifier_UABH_B, )
module UABPRIM_v1_0_9 (
    x0,
    vout,
    x1,
    x2,
    ...
    cy_psoc4_half_uab_v1_0 halfuab (
        .x0(x0),
        .x1(x1),
        .x2(x2),
        .x3(x3),
...
// Rectifier(FeedbackCapacitor=31, InputCapacitor=63, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=Rectifier, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Rectifier, CY_INSTANCE_SHORT_NAME=Rectifier, CY_MAJOR_VERSION=0, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=Rectifier, )
module Rectifier_10 (
    Vin,
    Vagnd,
    ZC,
...
// UABPRIM_v1_0(AGND_PTS=false, AGND_PWR=7, AGND_TIED=false, ALIGN_MODE=0, CA_BOOST=0, CA_VAL=0, CB_64=false, CB_BOOST=1, CB_GND=false, CB_VAL=5, CC_BOOST=2, CC_GND=false, CC_VAL=5, CC_VAL_UPDATE=false, CF_BOOST=2, CF_VAL=20, CF_VAL_UPDATE=false, CMP_DSI_LEVEL=1, CMP_EDGE=0, CMP_FF=15, CMP_PWR=7, COMP_MASK=false, DAC_MODE=0, DAC_MODE_EN=false, EARLY_PO=true, EARLY_PS=false, FRC_SIGN_BIT=false, LAST_STEP=1, MODBIT0_SRC_SEL=0, MODBIT1_SRC_SEL=0, OA_PWR=7, PUMP_WAVE=1, REF_PTS=false, REF_PWR=7, REF_TIED=false, SIGN_VAL=false, STARTUP_DELAY=0, STRB_RST_EN=0, STRB_RST_SEL=0, STROBE_RST=0, STROBE_SW=0, SUBSAMPLE=0, SUBSAMPLE_INIT=0, SUM_BOOST=2, SW_AA=0, SW_AA_1=0, SW_AG_MODBIT=0, SW_AP=0, SW_AQ=0, SW_AR_MODBIT=0, SW_AV_MODBIT=0, SW_AX0_MODBIT=0, SW_AX1_MODBIT=0, SW_AX2_MODBIT=0, SW_AX3_MODBIT=0, SW_BB=0, SW_BG_MODBIT=0, SW_BP=2, SW_BQ=0, SW_BR_MODBIT=0, SW_BV_MODBIT=0, SW_BX0_MODBIT=1, SW_BX1_MODBIT=0, SW_BX2_MODBIT=0, SW_BX3_MODBIT=0, SW_CC=0, SW_CG_MODBIT=0, SW_CP=1, SW_CQ=0, SW_CR_MODBIT=0, SW_CV_MODBIT=0, SW_CX0_MODBIT=2, SW_CX1_MODBIT=0, SW_CX2_MODBIT=0, SW_CX3_MODBIT=0, SW_GA_MODBIT=0, SW_GB_MODBIT=1, SW_GC_MODBIT=2, SW_GF=0, SW_GG=1, SW_GT=1, SW_GX0=0, SW_GX1=0, SW_GX2=0, SW_GX3=0, SW_PF=15, SW_PO=3, SW_PS=0, SW_QT=0, SW_RA_MODBIT=0, SW_RB_MODBIT=0, SW_RC_MODBIT=0, SW_RG=0, SW_RT=0, SW_SA=0, SW_SB=2, SW_SC=1, SW_TB=15, SW_TC=15, SW_VA_MODBIT=0, SW_VB_MODBIT=0, SW_VC_MODBIT=0, SW_ZC=0, TRIG_OUT=0, TRIG_SEL=0, TRIGGER_EN=false, UAB_PWR=2, VALID_WAVE=15, VDAC_EMPTY_MASK=false, WAVE_STEP_0=5, WAVE_STEP_1=6, WAVE_STEP_10=0, WAVE_STEP_11=0, WAVE_STEP_12=0, WAVE_STEP_13=0, WAVE_STEP_14=0, WAVE_STEP_15=0, WAVE_STEP_2=0, WAVE_STEP_3=0, WAVE_STEP_4=0, WAVE_STEP_5=0, WAVE_STEP_6=0, WAVE_STEP_7=0, WAVE_STEP_8=0, WAVE_STEP_9=0, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=UABPRIM_v1_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=DownMixer:UABH_A, CY_INSTANCE_SHORT_NAME=UABH_A, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=DownMixer_UABH_A, )
module UABPRIM_v1_0_11 (
    x0,
    vout,
    x1,
    x2,
...
// DownMixer(FeedbackCapacitor=20, InputCapacitor=5, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=DownMixer, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=DownMixer, CY_INSTANCE_SHORT_NAME=DownMixer, CY_MAJOR_VERSION=0, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=DownMixer, )
module DownMixer_12 (
    F_In,
    Clk,
    F_Out,
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("75a84975-39fc-4fd2-92c2-f5c652152bde"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("f63bd201-4297-4885-91c1-ed289c66c1bf"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("423b1792-8b51-4817-a686-2e026e346fa5"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("1978fcf0-e02a-410c-89e6-881b9b227a28"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    cy_annotation_universal_v1_0 R89 (
        .connect({
            Net_2524,
            Net_12
        })
    );
    defparam R89.comp_name = "Resistor_v1_0";
    defparam R89.port_names = "T1, T2";
    defparam R89.width = 2;

    Scan_ADC_v1_10_1 ADC (
        .sdone(Net_4470),
        .eos(Net_4471),
        .t_chidv(Net_4472),
        .t_chid(Net_4473),
    ...
    OpAmp_P4_v1_20_3 VrefBuffer (
        .Vplus(Net_2511),
        .Vout(VrefBus),
        .Vminus(Net_2525));

    cy_annotation_universal_v1_0 RT1 (
        .connect({
            Net_12,
            Net_33
        })
    );
    defparam RT1.comp_name = "Thermistor_v1_0";
    defparam RT1.port_names = "T1, T2";
    defparam RT1.width = 2;
	...
	cy_psoc3_pins_v1_10
		#(.id("15726d0f-0161-403c-9e5a-914bb6270a63"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("a21ae986-ea7a-42b9-8d2d-07025a19424e"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__TIA_REF_net;
	wire [0:0] tmpFB_0__TIA_REF_net;
	wire [0:0] tmpIO_0__TIA_REF_net;
	wire [0:0] tmpINTERRUPT_0__TIA_REF_net;
	electrical [0:0] tmpSIOVREF__TIA_REF_net;

	cy_psoc3_pins_v1_10
		#(.id("1fea83b6-8cb5-4429-a3e4-f7a795685b27"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		TIA_REF
		 (.oe(tmpOE__TIA_REF_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__TIA_REF_net[0:0]}),
		  .analog({VALS_N}),
		  .io({tmpIO_0__TIA_REF_net[0:0]}),
		  .siovref(tmpSIOVREF__TIA_REF_net),
		  .interrupt({tmpINTERRUPT_0__TIA_REF_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__TIA_REF_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__Pin_PIRRef_net;
	wire [0:0] tmpFB_0__Pin_PIRRef_net;
	wire [0:0] tmpIO_0__Pin_PIRRef_net;
	wire [0:0] tmpINTERRUPT_0__Pin_PIRRef_net;
	electrical [0:0] tmpSIOVREF__Pin_PIRRef_net;

	cy_psoc3_pins_v1_10
		#(.id("f86011c9-dd9e-4028-ac1b-852f142555b2"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_PIRRef
		 (.oe(tmpOE__Pin_PIRRef_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_PIRRef_net[0:0]}),
		  .analog({Net_1504}),
		  .io({tmpIO_0__Pin_PIRRef_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_PIRRef_net),
		  .interrupt({tmpINTERRUPT_0__Pin_PIRRef_net[0:0]}),
		  .annotation({Net_1543}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_PIRRef_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    cy_annotation_universal_v1_0 R_56 (
        .connect({
            Net_1524,
            Net_1505
        })
    );
    defparam R_56.comp_name = "Resistor_v1_0";
    defparam R_56.port_names = "T1, T2";
    defparam R_56.width = 2;

    cy_annotation_universal_v1_0 C_48 (
        .connect({
            Net_1407,
            Net_1524
        })
    );
    defparam C_48.comp_name = "Capacitor_v1_0";
    defparam C_48.port_names = "T1, T2";
    defparam C_48.width = 2;

    cy_annotation_universal_v1_0 R_55 (
        .connect({
            Net_1407,
            Net_1484
        })
    );
    defparam R_55.comp_name = "Resistor_v1_0";
    defparam R_55.port_names = "T1, T2";
    defparam R_55.width = 2;

    cy_annotation_universal_v1_0 C_49 (
        .connect({
            Net_1407,
            Net_1484
        })
    );
    defparam C_49.comp_name = "Capacitor_v1_0";
    defparam C_49.port_names = "T1, T2";
    defparam C_49.width = 2;

	wire [0:0] tmpOE__Pin_PIR_net;
	wire [0:0] tmpFB_0__Pin_PIR_net;
	wire [0:0] tmpIO_0__Pin_PIR_net;
	wire [0:0] tmpINTERRUPT_0__Pin_PIR_net;
	electrical [0:0] tmpSIOVREF__Pin_PIR_net;

	cy_psoc3_pins_v1_10
		#(.id("44906ce7-f1c1-4a6d-94af-f4a5e140587f"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_PIR
		 (.oe(tmpOE__Pin_PIR_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_PIR_net[0:0]}),
		  .analog({Net_1425}),
		  .io({tmpIO_0__Pin_PIR_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_PIR_net),
		  .interrupt({tmpINTERRUPT_0__Pin_PIR_net[0:0]}),
		  .annotation({Net_1524}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_PIR_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    cy_annotation_universal_v1_0 R_119 (
        .connect({
            Net_1505,
            Net_1543
        })
    );
    defparam R_119.comp_name = "Resistor_v1_0";
    defparam R_119.port_names = "T1, T2";
    defparam R_119.width = 2;

    cy_annotation_universal_v1_0 R_118 (
        .connect({
            Net_1543,
            Net_1516
        })
    );
    defparam R_118.comp_name = "Resistor_v1_0";
    defparam R_118.port_names = "T1, T2";
    defparam R_118.width = 2;

    cy_annotation_universal_v1_0 C_81 (
        .connect({
            Net_1543,
            Net_1516
        })
    );
    defparam C_81.comp_name = "Capacitor_v1_0";
    defparam C_81.port_names = "T1, T2";
    defparam C_81.width = 2;

    OpAmp_P4_v1_20_4 PIRAmplifierStage1 (
        .Vplus(Net_1425),
        .Vout(PIR),
        .Vminus(Net_1504));
    ...
    cy_annotation_universal_v1_0 C_52 (
        .connect({
            Net_1484,
            Net_1715
        })
    );
    defparam C_52.comp_name = "Capacitor_v1_0";
    defparam C_52.port_names = "T1, T2";
    defparam C_52.width = 2;

    cy_annotation_universal_v1_0 R_58 (
        .connect({
            Net_1715,
            Net_1505
        })
    );
    defparam R_58.comp_name = "Resistor_v1_0";
    defparam R_58.port_names = "T1, T2";
    defparam R_58.width = 2;

	wire [0:0] tmpOE__Pin_PIRAmpOut_net;
	wire [0:0] tmpFB_0__Pin_PIRAmpOut_net;
	wire [0:0] tmpIO_0__Pin_PIRAmpOut_net;
	wire [0:0] tmpINTERRUPT_0__Pin_PIRAmpOut_net;
	electrical [0:0] tmpSIOVREF__Pin_PIRAmpOut_net;

	cy_psoc3_pins_v1_10
		#(.id("16623aee-7bf1-46f6-a66d-491d63eda1df"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_PIRAmpOut
		 (.oe(tmpOE__Pin_PIRAmpOut_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_PIRAmpOut_net[0:0]}),
		  .analog({PIR}),
		  .io({tmpIO_0__Pin_PIRAmpOut_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_PIRAmpOut_net),
		  .interrupt({tmpINTERRUPT_0__Pin_PIRAmpOut_net[0:0]}),
		  .annotation({Net_1516}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_PIRAmpOut_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


	cy_clock_v1_0
		#(.id("e0b15759-b29e-4106-94d6-e70eb9adbf3c"),
		  .source_clock_id("413DE2EF-D9F2-4233-A808-DFAF137FD877"),
		  .divisor(0),
		  .period("125000000"),
		  .is_direct(0),
    ...
    cy_annotation_universal_v1_0 L (
        .connect({
            Net_1409,
            Net_3234
        })
    );
    defparam L.comp_name = "Inductor_v1_0";
    defparam L.port_names = "T1, T2";
    defparam L.width = 2;
    ...
    cy_annotation_universal_v1_0 Cs (
        .connect({
            Net_1031,
            Net_1032
        })
    );
    defparam Cs.comp_name = "Capacitor_v1_0";
    defparam Cs.port_names = "T1, T2";
    defparam Cs.width = 2;

    cy_annotation_universal_v1_0 Cref (
        .connect({
            Net_2446,
            Net_1036
        })
    );
    defparam Cref.comp_name = "Capacitor_v1_0";
    defparam Cref.port_names = "T1, T2";
    defparam Cref.width = 2;

    TCPWM_P4_v2_10_6 Timebase5s (
        .stop(1'b0),
        .reload(1'b0),
        .start(1'b0),
        .count(1'b1),
    ...
    cy_annotation_universal_v1_0 R78 (
        .connect({
            Net_1139,
            Net_3235
        })
    );
    defparam R78.comp_name = "Resistor_v1_0";
    defparam R78.port_names = "T1, T2";
    defparam R78.width = 2;

    cy_annotation_universal_v1_0 C57 (
        .connect({
            Net_1409,
            Net_1139
        })
    );
    defparam C57.comp_name = "Capacitor_v1_0";
    defparam C57.port_names = "T1, T2";
    defparam C57.width = 2;
    ...
    cy_annotation_universal_v1_0 C80 (
        .connect({
            Net_1409,
            Net_3236
        })
    );
    defparam C80.comp_name = "Capacitor_v1_0";
    defparam C80.port_names = "T1, T2";
    defparam C80.width = 2;
	...
	wire [0:0] tmpOE__EXCITATION_net;
	wire [0:0] tmpFB_0__EXCITATION_net;
	wire [0:0] tmpIO_0__EXCITATION_net;
	wire [0:0] tmpINTERRUPT_0__EXCITATION_net;
	electrical [0:0] tmpSIOVREF__EXCITATION_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		EXCITATION
		 (.oe(tmpOE__EXCITATION_net),
		  .y({Net_1063}),
		  .fb({tmpFB_0__EXCITATION_net[0:0]}),
		  .io({tmpIO_0__EXCITATION_net[0:0]}),
		  .siovref(tmpSIOVREF__EXCITATION_net),
		  .interrupt({tmpINTERRUPT_0__EXCITATION_net[0:0]}),
		  .annotation({Net_962}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__EXCITATION_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


	cy_clock_v1_0
		#(.id("17d2f011-76d9-46e5-801b-28e1e925203e"),
		  .source_clock_id("413DE2EF-D9F2-4233-A808-DFAF137FD877"),
		  .divisor(3),
		  .period("0"),
		  .is_direct(0),
    ...
    TCPWM_P4_v2_10_8 ExcitationPWM (
        .stop(1'b0),
        .reload(1'b0),
        .start(1'b0),
        .count(1'b1),
	...
	wire [0:0] tmpOE__Sensor_Signal_net;
	wire [0:0] tmpFB_0__Sensor_Signal_net;
	wire [0:0] tmpIO_0__Sensor_Signal_net;
	wire [0:0] tmpINTERRUPT_0__Sensor_Signal_net;
	electrical [0:0] tmpSIOVREF__Sensor_Signal_net;

	cy_psoc3_pins_v1_10
		#(.id("319c2e28-6bc1-43a1-92ba-756f80dc3da6"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Sensor_Signal
		 (.oe(tmpOE__Sensor_Signal_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Sensor_Signal_net[0:0]}),
		  .analog({Net_1576}),
		  .io({tmpIO_0__Sensor_Signal_net[0:0]}),
		  .siovref(tmpSIOVREF__Sensor_Signal_net),
		  .interrupt({tmpINTERRUPT_0__Sensor_Signal_net[0:0]}),
		  .annotation({Net_1139}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Sensor_Signal_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    Rectifier_10 Rectifier (
        .Vin(Net_2108),
        .Vagnd(VrefBus),
        .ZC(Net_2169),
        .Clk(ADCClock),
	...
	cy_clock_v1_0
		#(.id("20c78198-a984-4f9f-a8a6-28c9a7c12152"),
		  .source_clock_id("413DE2EF-D9F2-4233-A808-DFAF137FD877"),
		  .divisor(0),
		  .period("500000000"),
		  .is_direct(0),
