...
#define DownMixer_UABH_A_MIN(x, y)  ( ((x)>(y))? (y) : (x) )

/*(0x00001fffUL)*/
#define CyUAB_DAC_NEXT_MASK   (DownMixer_UABH_A_SIGN_VAL_MASK | DownMixer_UABH_A_CA_VAL_MASK | DownMixer_UABH_A_CB_VAL_MASK)
#define CyUAB_DAC_NEXT_SHIFT  (DownMixer_UABH_A_CB_VAL_SHIFT)
    
/*(0x00000fffUL)*/
#define CyUAB_CF_NEXT_MASK    (DownMixer_UABH_A_CF_VAL_MASK | DownMixer_UABH_A_CC_VAL_MASK)
...
#define CyUAB_SRAM_OFFSET  ( ((uint32)DownMixer_UABH_A_SRAM0_PTR) - ((uint32)DownMixer_UABH_A_BASE_ADDR) )
