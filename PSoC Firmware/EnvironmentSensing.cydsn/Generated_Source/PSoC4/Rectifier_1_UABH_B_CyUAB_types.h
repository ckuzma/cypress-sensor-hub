/*!*****************************************************************************
* \file Rectifier_1_UABH_B_CyUAB_types.h
* \version 1.0
*
* \brief 
...
@see Rectifier_1_UABH_B_Init() and Rectifier_1_UABH_B_Start()
*******************************************************************************/
typedef struct{
...
when it is off.
@see Rectifier_1_UABH_B_SetCompOutInvert()
*******************************************************************************/
typedef enum{
...
@see Rectifier_1_UABH_B_SetRefVdda()
*******************************************************************************/
typedef enum{
...
@see Rectifier_1_UABH_B_SetAgndVdda()
*******************************************************************************/
typedef enum{
...
@see Rectifier_1_UABH_B_SetAgndSharing()
*******************************************************************************/
typedef enum{
...
@see Rectifier_1_UABH_B_SetRefSharing()
*******************************************************************************/
typedef enum{
...
@see Rectifier_1_UABH_B_SetEarly()
*******************************************************************************/
typedef enum{
...
@see CyUAB_SetSwitch()
@see Rectifier_1_UABH_B_SetSwitch()
@see Rectifier_1_UABH_B_SetCompoutFFClock()
@see Rectifier_1_UABH_B_SetValidClock()
@see Rectifier_1_UABH_B_SetTrigClock()
@see Rectifier_1_UABH_B_SetStrobeClock()
*******************************************************************************/
typedef enum{
    ...
    /*reserved*/
    /*Rectifier_1_UABH_B_CLK_RESERVED1 = 13,*/
    /*Rectifier_1_UABH_B_CLK_RESERVED2 = 14,*/
...
Refer to Rectifier_1_UABH_B.h for x input to vin input shuffling implementation details
...
typedef enum{
    ...
    /* Static Switches */    
    CyUAB_SW_GX0 = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_STATIC_ADDR,Rectifier_1_UABH_B_SW_G0_SHIFT, CyUAB_SW_X),    /**< static: OA+ <-> X0 */
    CyUAB_SW_GX1 = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_STATIC_ADDR,Rectifier_1_UABH_B_SW_G1_SHIFT, CyUAB_SW_X),    /**< static: OA+ <-> X1 */  
    CyUAB_SW_GX2 = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_STATIC_ADDR,Rectifier_1_UABH_B_SW_G2_SHIFT, CyUAB_SW_X),    /**< static: OA+ <-> X2 */  
    CyUAB_SW_GX3 = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_STATIC_ADDR,Rectifier_1_UABH_B_SW_G3_SHIFT, CyUAB_SW_X),    /**< static: OA+ <-> X3 */  
    CyUAB_SW_RG  = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_STATIC_ADDR,Rectifier_1_UABH_B_SW_RG_SHIFT, CyUAB_SW_NOX),  /**< static: OA+ <-> REF */   
    CyUAB_SW_GG  = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_STATIC_ADDR,Rectifier_1_UABH_B_SW_GG_SHIFT, CyUAB_SW_NOX),  /**< static: OA+ <-> AGND */   
    CyUAB_SW_RT  = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_STATIC_ADDR,Rectifier_1_UABH_B_SW_RT_SHIFT, CyUAB_SW_NOX),  /**< static: CMP+ <-> REF */  
    CyUAB_SW_GT  = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_STATIC_ADDR,Rectifier_1_UABH_B_SW_GT_SHIFT, CyUAB_SW_NOX),  /**< static: CMP+ <-> AGND */ 
    CyUAB_SW_QT  = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_STATIC_ADDR,Rectifier_1_UABH_B_SW_QT_SHIFT, CyUAB_SW_NOX),  /**< static: CMP+ <-> OUT from other half */
    
    /* Dynamic Switches */
    /* reg SW_CAx_IN0 */
    CyUAB_SW_AX0_MODBIT = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_CA_IN0_ADDR,Rectifier_1_UABH_B_SW_A0_MODBIT_SHIFT,  CyUAB_SW_X), /**< A in <-> X0 */
    CyUAB_SW_AX1_MODBIT = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_CA_IN0_ADDR,Rectifier_1_UABH_B_SW_A1_MODBIT_SHIFT,  CyUAB_SW_X),   /**< A in <-> X1 */  
    CyUAB_SW_AX2_MODBIT = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_CA_IN0_ADDR,Rectifier_1_UABH_B_SW_A2_MODBIT_SHIFT,  CyUAB_SW_X),   /**< A in <-> X2 */  
    CyUAB_SW_AX3_MODBIT = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_CA_IN0_ADDR,Rectifier_1_UABH_B_SW_A3_MODBIT_SHIFT,  CyUAB_SW_X),   /**< A in <-> X3 */  
    CyUAB_SW_AP         = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_CA_IN0_ADDR,Rectifier_1_UABH_B_SW_AP_SHIFT,       CyUAB_SW_NOX), /**< A in <-> VOUT */  
    CyUAB_SW_AQ         = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_CA_IN0_ADDR,Rectifier_1_UABH_B_SW_AQ_SHIFT,       CyUAB_SW_NOX), /**< A in <-> VOUT from other half */
    /* reg SW_CAx_IN1 */
    CyUAB_SW_AA         = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_CA_IN1_ADDR,Rectifier_1_UABH_B_SW_AA_SHIFT,        CyUAB_SW_NOX), /**< short A inputs between each half - NOTE: exists only in half0 */ 
    CyUAB_SW_AR_MODBIT  = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_CA_IN1_ADDR,Rectifier_1_UABH_B_SW_AR_MODBIT_SHIFT, CyUAB_SW_NOX), /**< A in <-> REF */
    CyUAB_SW_AG_MODBIT  = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_CA_IN1_ADDR,Rectifier_1_UABH_B_SW_AG_MODBIT_SHIFT, CyUAB_SW_NOX), /**< A in <-> AGND */
    CyUAB_SW_AV_MODBIT  = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_CA_IN1_ADDR,Rectifier_1_UABH_B_SW_AV_MODBIT_SHIFT, CyUAB_SW_NOX), /**< A in <-> VSS */
    /*reg SW_CAx_TOP */
    CyUAB_SW_RA_MODBIT  = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_CA_TOP_ADDR,Rectifier_1_UABH_B_SW_RA_MODBIT_SHIFT, CyUAB_SW_NOX), /**< A top <-> REF */
    CyUAB_SW_GA_MODBIT  = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_CA_TOP_ADDR,Rectifier_1_UABH_B_SW_GA_MODBIT_SHIFT, CyUAB_SW_NOX), /**< A top <-> AGND */
    CyUAB_SW_VA_MODBIT  = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_CA_TOP_ADDR,Rectifier_1_UABH_B_SW_VA_MODBIT_SHIFT, CyUAB_SW_NOX), /**< A top <-> VSS */
    /* OK: nothing at bits 15:12 */
    CyUAB_SW_SA         = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_CA_TOP_ADDR,Rectifier_1_UABH_B_SW_SA_SHIFT,        CyUAB_SW_NOX), /**< A top <-> SUM */
    /*reg SW_CBx_IN0 */
    CyUAB_SW_BX0_MODBIT = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_CB_IN0_ADDR,Rectifier_1_UABH_B_SW_B0_MODBIT_SHIFT,  CyUAB_SW_X), /**< B in <-> X0 */
    CyUAB_SW_BX1_MODBIT = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_CB_IN0_ADDR,Rectifier_1_UABH_B_SW_B1_MODBIT_SHIFT,  CyUAB_SW_X), /**< B in <-> X1 */
    CyUAB_SW_BX2_MODBIT = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_CB_IN0_ADDR,Rectifier_1_UABH_B_SW_B2_MODBIT_SHIFT,  CyUAB_SW_X), /**< B in <-> X2 */
    CyUAB_SW_BX3_MODBIT = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_CB_IN0_ADDR,Rectifier_1_UABH_B_SW_B3_MODBIT_SHIFT,  CyUAB_SW_X), /**< B in <-> X3 */
    CyUAB_SW_BP         = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_CB_IN0_ADDR,Rectifier_1_UABH_B_SW_BP_SHIFT,        CyUAB_SW_NOX), /**< B in <-> VOUT */
    CyUAB_SW_BQ         = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_CB_IN0_ADDR,Rectifier_1_UABH_B_SW_BQ_SHIFT,        CyUAB_SW_NOX), /**< B in <-> VOUT from other half */
    /* reg SW_CBx_IN1 */
    CyUAB_SW_BB         = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_CB_IN1_ADDR,Rectifier_1_UABH_B_SW_BB_SHIFT,        CyUAB_SW_NOX), /**< short B inputs between each half - NOTE: exists only in half0 */
    CyUAB_SW_BR_MODBIT  = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_CB_IN1_ADDR,Rectifier_1_UABH_B_SW_BR_MODBIT_SHIFT, CyUAB_SW_NOX), /**< B in <-> REF */
    CyUAB_SW_BG_MODBIT  = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_CB_IN1_ADDR,Rectifier_1_UABH_B_SW_BG_MODBIT_SHIFT, CyUAB_SW_NOX), /**< B in <-> AGND */
    CyUAB_SW_BV_MODBIT  = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_CB_IN1_ADDR,Rectifier_1_UABH_B_SW_BV_MODBIT_SHIFT, CyUAB_SW_NOX), /**< B in <-> VSS */   
    /* reg SW_CBx_TOP */
    CyUAB_SW_RB_MODBIT  = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_CB_TOP_ADDR,Rectifier_1_UABH_B_SW_RB_MODBIT_SHIFT, CyUAB_SW_NOX), /**< B top <-> REF */   
    CyUAB_SW_GB_MODBIT  = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_CB_TOP_ADDR,Rectifier_1_UABH_B_SW_GB_MODBIT_SHIFT, CyUAB_SW_NOX), /**< B top <-> AGND */ 
    CyUAB_SW_VB_MODBIT  = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_CB_TOP_ADDR,Rectifier_1_UABH_B_SW_VB_MODBIT_SHIFT, CyUAB_SW_NOX), /**< B top <-> VSS */  
    CyUAB_SW_TB         = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_CB_TOP_ADDR,Rectifier_1_UABH_B_SW_TB_SHIFT,        CyUAB_SW_NOX), /**< B top <-> trim/attenuator bypass */
    CyUAB_SW_SB         = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_CB_TOP_ADDR,Rectifier_1_UABH_B_SW_SB_SHIFT,        CyUAB_SW_NOX), /**< B top <-> SUM */  
    /* reg SW_CCx_IN0 */
    CyUAB_SW_CX0_MODBIT = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_CC_IN0_ADDR,Rectifier_1_UABH_B_SW_C0_MODBIT_SHIFT,  CyUAB_SW_X), /**< C in <-> X0 */  
    CyUAB_SW_CX1_MODBIT = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_CC_IN0_ADDR,Rectifier_1_UABH_B_SW_C1_MODBIT_SHIFT,  CyUAB_SW_X), /**< C in <-> X1 */  
    CyUAB_SW_CX2_MODBIT = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_CC_IN0_ADDR,Rectifier_1_UABH_B_SW_C2_MODBIT_SHIFT,  CyUAB_SW_X), /**< C in <-> X2 */  
    CyUAB_SW_CX3_MODBIT = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_CC_IN0_ADDR,Rectifier_1_UABH_B_SW_C3_MODBIT_SHIFT,  CyUAB_SW_X), /**< C in <-> X3 */  
    CyUAB_SW_CP         = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_CC_IN0_ADDR,Rectifier_1_UABH_B_SW_CP_SHIFT,        CyUAB_SW_NOX), /**< C in <-> SUM */   
    CyUAB_SW_CQ         = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_CC_IN0_ADDR,Rectifier_1_UABH_B_SW_CQ_SHIFT,        CyUAB_SW_NOX), /**< C in <-> SUM from other half */
    /* reg SW_CCx_IN1 */
    CyUAB_SW_CC         = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_CC_IN1_ADDR,Rectifier_1_UABH_B_SW_CC_SHIFT,        CyUAB_SW_NOX), /**< short C inputs between each half */         
    CyUAB_SW_CR_MODBIT  = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_CC_IN1_ADDR,Rectifier_1_UABH_B_SW_CR_MODBIT_SHIFT, CyUAB_SW_NOX), /**< C in <-> REF */   
    CyUAB_SW_CG_MODBIT  = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_CC_IN1_ADDR,Rectifier_1_UABH_B_SW_CG_MODBIT_SHIFT, CyUAB_SW_NOX), /**< C in <-> AGND */  
    CyUAB_SW_CV_MODBIT  = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_CC_IN1_ADDR,Rectifier_1_UABH_B_SW_CV_MODBIT_SHIFT, CyUAB_SW_NOX), /**< C in <-> VSS */   
    /* reg SW_CCx_TOP */
    CyUAB_SW_RC_MODBIT  = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_CC_TOP_ADDR,Rectifier_1_UABH_B_SW_RC_MODBIT_SHIFT, CyUAB_SW_NOX), /**< C top <-> REF */  
    CyUAB_SW_GC_MODBIT  = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_CC_TOP_ADDR,Rectifier_1_UABH_B_SW_GC_MODBIT_SHIFT, CyUAB_SW_NOX), /**< C top <-> AGND */ 
    CyUAB_SW_VC_MODBIT  = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_CC_TOP_ADDR,Rectifier_1_UABH_B_SW_VC_MODBIT_SHIFT, CyUAB_SW_NOX), /**< C top <-> VSS */  
    CyUAB_SW_TC         = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_CC_TOP_ADDR,Rectifier_1_UABH_B_SW_TC_SHIFT,        CyUAB_SW_NOX), /**< C top <-> trim/attenuator bypass */ 
    CyUAB_SW_SC         = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_CC_TOP_ADDR,Rectifier_1_UABH_B_SW_SC_SHIFT,        CyUAB_SW_NOX), /**< C top <-> sum */  
    CyUAB_SW_ZC         = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_CC_TOP_ADDR,Rectifier_1_UABH_B_SW_ZC_SHIFT,        CyUAB_SW_NOX), /**< C top <-> sum from other half */ 
    /* reg SW_CFx_BOT  */ 
    CyUAB_SW_GF         = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_CF_BOT_ADDR,Rectifier_1_UABH_B_SW_GF_SHIFT, CyUAB_SW_NOX), /**< F bot <-> AGND */ 
    CyUAB_SW_PF         = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_CF_BOT_ADDR,Rectifier_1_UABH_B_SW_PF_SHIFT, CyUAB_SW_NOX), /**< F bot <-> VOUT */ 
    CyUAB_SW_PS         = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_CF_BOT_ADDR,Rectifier_1_UABH_B_SW_PS_SHIFT, CyUAB_SW_NOX), /**< F bypass, OUT <-> SUM */ 
    CyUAB_SW_PO         = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_CF_BOT_ADDR,Rectifier_1_UABH_B_SW_PO_SHIFT, CyUAB_SW_NOX), /**< OUT <-> VOUT */   
    
    /* reg SW_OTHERx */
    CyUAB_SW_CMP_FF     = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_OTHER_ADDR,Rectifier_1_UABH_B_CMP_FF_SHIFT,     CyUAB_SW_NOX), /**< Clock for FF after Comparator */
    CyUAB_SW_VALID      = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_OTHER_ADDR,Rectifier_1_UABH_B_VALID_SHIFT,      CyUAB_SW_NOX), /**< Valid output flag */
    CyUAB_SW_TRIG_OUT   = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_OTHER_ADDR,Rectifier_1_UABH_B_TRIG_OUT_SHIFT,   CyUAB_SW_NOX), /**< Trigger output */
    CyUAB_SW_STROBE_SW  = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_OTHER_ADDR,Rectifier_1_UABH_B_STROBE_SW_SHIFT,  CyUAB_SW_NOX), /**< Strobe sync waveform selection */
    CyUAB_SW_STROBE_RST = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_OTHER_ADDR,Rectifier_1_UABH_B_STROBE_RST_SHIFT, CyUAB_SW_NOX), /**< Reset waveform selection */
    
    /* SW_BOOST_CTRL */
    CyUAB_SW_A_BOOST    = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_BOOST_CTRL_ADDR,Rectifier_1_UABH_B_CA_BOOST_SHIFT,  CyUAB_SW_NOX), /**< Boost A */        
    CyUAB_SW_B_BOOST    = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_BOOST_CTRL_ADDR,Rectifier_1_UABH_B_CB_BOOST_SHIFT,  CyUAB_SW_NOX), /**< Boost B */        
    CyUAB_SW_C_BOOST    = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_BOOST_CTRL_ADDR,Rectifier_1_UABH_B_CC_BOOST_SHIFT,  CyUAB_SW_NOX), /**< Boost C */        
    CyUAB_SW_F_BOOST    = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_BOOST_CTRL_ADDR,Rectifier_1_UABH_B_CF_BOOST_SHIFT,  CyUAB_SW_NOX), /**< Boost F */        
    CyUAB_SW_SUM_BOOST  = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_BOOST_CTRL_ADDR,Rectifier_1_UABH_B_SUM_BOOST_SHIFT, CyUAB_SW_NOX), /**< SUM */            
    CyUAB_SW_PUMP_WAVE  = CyUAB_SW_ID(Rectifier_1_UABH_B_SW_BOOST_CTRL_ADDR,Rectifier_1_UABH_B_PUMP_WAVE_SHIFT, CyUAB_SW_NOX)  /**< Pump */           
