...
#if !defined(DownMixer_UABH_A_H)
#define DownMixer_UABH_A_H
...
#define DownMixer_UABH_A_STATIC_FIELD_SIZE  1UL

/* Spacing between the LSbit of each dynamic switch field */
/* needed when converting between the field shift location and the number of the shuffled x analog inputs */
#define DownMixer_UABH_A_DYNAMIC_FIELD_SIZE 4UL


/*Macros*/

/* Find UAB vin input index from UABPRIM x input index with cyfitter.h mappings */
#if !defined(DownMixer_UABH_A_Vin)
#define DownMixer_UABH_A_Vin(xIndex) (\
    (0UL==(xIndex))? ((uint32)DownMixer_UABH_A_X0) : (\
    (1UL==(xIndex))? ((uint32)DownMixer_UABH_A_X1) : (\
    (2UL==(xIndex))? ((uint32)DownMixer_UABH_A_X2) : (\
                   ((uint32)DownMixer_UABH_A_X3) \
))))
#endif
    
/* static switch, get x input index from switch id by down-scaling the x input field shift value by the field size */
#define DownMixer_UABH_A_StaticXin(sw_id)     ( CyUAB_GetSwShift((sw_id)) / DownMixer_UABH_A_STATIC_FIELD_SIZE )    
...
#define DownMixer_UABH_A_StaticVShift(sw_id)  ( DownMixer_UABH_A_Vin( DownMixer_UABH_A_StaticXin((sw_id)) ) * DownMixer_UABH_A_STATIC_FIELD_SIZE )
/* static switch, if id refers to an x input, handle the shuffling, otherwise just unpack the field shift from id */
#define DownMixer_UABH_A_StaticSwShift(sw_id)   ( CyUAB_IsSwX((sw_id)) ? DownMixer_UABH_A_StaticVShift((sw_id)) : CyUAB_GetSwShift((sw_id)) )
/* static switch, post shift mask */
#define DownMixer_UABH_A_StaticSwMask(sw_id)    ( DownMixer_UABH_A_STATIC_PRESHIFT_MASK<<DownMixer_UABH_A_StaticSwShift((sw_id)) )

/* static switch address */
#define DownMixer_UABH_A_GetStaticSwAddr(sw_id)  ( (reg32*)( ((uint32)DownMixer_UABH_A_BASE_ADDR) + ((uint32)(CyUAB_GetSwAddr((sw_id)) )) ) )
    

/* dynamic switch, get x input index from switch id by down-scaling the x input field shift value by the field size */
#define DownMixer_UABH_A_DynamicXin(sw_id)    ( CyUAB_GetSwShift((sw_id)) / DownMixer_UABH_A_DYNAMIC_FIELD_SIZE )
...
#define DownMixer_UABH_A_DynamicVShift(sw_id) ( DownMixer_UABH_A_Vin( DownMixer_UABH_A_DynamicXin((sw_id)) ) * DownMixer_UABH_A_DYNAMIC_FIELD_SIZE )
/* dynamic switch, if id refers to an x input, handle the shuffling, otherwise just unpack the field shift from id */
#define DownMixer_UABH_A_DynamicSwShift(sw_id)  ( CyUAB_IsSwX((sw_id)) ? DownMixer_UABH_A_DynamicVShift((sw_id)) : CyUAB_GetSwShift((sw_id)) )
/* dynamic switch, post shift mask */
#define DownMixer_UABH_A_DynamicSwMask(sw_id)   ( DownMixer_UABH_A_DYNAMIC_PRESHIFT_MASK<<DownMixer_UABH_A_DynamicSwShift((sw_id)) )

/* dynamic switch address - handle SW_AA, SW_BB, and SW_CC */
#define DownMixer_UABH_A_GetDynamicSwAddr(sw_id)  ( (CyUAB_SW_AA==(sw_id)) ? DownMixer_UABH_A_SW_AA_PTR : (\
    (CyUAB_SW_BB==(sw_id)) ? DownMixer_UABH_A_SW_BB_PTR : ( \
    (CyUAB_SW_CC==(sw_id)) ? DownMixer_UABH_A_SW_CC_PTR : ( \
    ( (reg32*)( ((uint32)DownMixer_UABH_A_BASE_ADDR) + ((uint32)(CyUAB_GetSwAddr((sw_id)) )) ) ) \
) ) ) )
...
#define DownMixer_UABH_A_NUM_STEPS ( (uint8)( \
(DownMixer_UABH_A_INC_STEP_0  ? 1UL : 0UL) + \
(DownMixer_UABH_A_INC_STEP_1  ? 1UL : 0UL) + \
(DownMixer_UABH_A_INC_STEP_2  ? 1UL : 0UL) + \
(DownMixer_UABH_A_INC_STEP_3  ? 1UL : 0UL) + \
(DownMixer_UABH_A_INC_STEP_4  ? 1UL : 0UL) + \
(DownMixer_UABH_A_INC_STEP_5  ? 1UL : 0UL) + \
(DownMixer_UABH_A_INC_STEP_6  ? 1UL : 0UL) + \
(DownMixer_UABH_A_INC_STEP_7  ? 1UL : 0UL) + \
(DownMixer_UABH_A_INC_STEP_8  ? 1UL : 0UL) + \
(DownMixer_UABH_A_INC_STEP_9  ? 1UL : 0UL) + \
(DownMixer_UABH_A_INC_STEP_10 ? 1UL : 0UL) + \
(DownMixer_UABH_A_INC_STEP_11 ? 1UL : 0UL) + \
(DownMixer_UABH_A_INC_STEP_12 ? 1UL : 0UL) + \
(DownMixer_UABH_A_INC_STEP_13 ? 1UL : 0UL) + \
(DownMixer_UABH_A_INC_STEP_14 ? 1UL : 0UL) + \
(DownMixer_UABH_A_INC_STEP_15 ? 1UL : 0UL) ) )

/*! initPairs array index of default OA_CTRL */
#define DownMixer_UABH_A_IDX_OA_CTRL       (0UL)
/*! initPairs array index of default SW_STATIC */
#define DownMixer_UABH_A_IDX_SW_STATIC     (1UL)
/*! initPairs array index of default SW_MODBIT_SRC */
#define DownMixer_UABH_A_IDX_SW_MODBIT_SRC (2UL)
/*! initPairs array index of default SRAM_CTRL */
#define DownMixer_UABH_A_IDX_SRAM_CTRL     (3UL)

/*! Calculate initPairs array size*/
#define DownMixer_UABH_A_INIT_PAIRS_COUNT ( \
(DownMixer_UABH_A_NONZERO_OA_CTRL        ? 1UL : 0UL) + \
(DownMixer_UABH_A_NONZERO_SW_STATIC      ? 1UL : 0UL) + \
(DownMixer_UABH_A_NONZERO_SW_MODBIT_SRC  ? 1UL : 0UL) + \
(DownMixer_UABH_A_NONZERO_SRAM_CTRL      ? 1UL : 0UL) + \
  \
(DownMixer_UABH_A_NONZERO_INTR_MASK      ? 1UL : 0UL) + \
(DownMixer_UABH_A_NONZERO_CAP_CTRL       ? 1UL : 0UL) + \
(DownMixer_UABH_A_NONZERO_CAP_ABCF_VAL   ? 1UL : 0UL) + \
(DownMixer_UABH_A_NONZERO_CAP_AB_VAL_NXT ? 1UL : 0UL) + \
(DownMixer_UABH_A_NONZERO_CAP_CF_VAL_NXT ? 1UL : 0UL) + \
(DownMixer_UABH_A_NONZERO_STARTUP_DELAY  ? 1UL : 0UL) + \
(DownMixer_UABH_A_NONZERO_SUBSAMPLE_CTRL ? 1UL : 0UL) + \
(DownMixer_UABH_A_NONZERO_SW_CA_IN0      ? 1UL : 0UL) + \
(DownMixer_UABH_A_NONZERO_SW_CA_IN1      ? 1UL : 0UL) + \
(DownMixer_UABH_A_NONZERO_SW_CA_TOP      ? 1UL : 0UL) + \
(DownMixer_UABH_A_NONZERO_SW_CB_IN0      ? 1UL : 0UL) + \
(DownMixer_UABH_A_NONZERO_SW_CB_IN1      ? 1UL : 0UL) + \
(DownMixer_UABH_A_NONZERO_SW_CB_TOP      ? 1UL : 0UL) + \
(DownMixer_UABH_A_NONZERO_SW_CC_IN0      ? 1UL : 0UL) + \
(DownMixer_UABH_A_NONZERO_SW_CC_IN1      ? 1UL : 0UL) + \
(DownMixer_UABH_A_NONZERO_SW_CC_TOP      ? 1UL : 0UL) + \
(DownMixer_UABH_A_NONZERO_SW_CF_BOT      ? 1UL : 0UL) + \
(DownMixer_UABH_A_NONZERO_SW_OTHER       ? 1UL : 0UL) + \
(DownMixer_UABH_A_NONZERO_SW_BOOST_CTRL  ? 1UL : 0UL) \
)
...
extern uint32 DownMixer_UABH_A_initVar;
extern CyUAB_config DownMixer_UABH_A_config;
extern uint16 DownMixer_UABH_A_waveConfig[DownMixer_UABH_A_NUM_STEPS];
extern CyUAB_reg_pair DownMixer_UABH_A_initPairs[DownMixer_UABH_A_INIT_PAIRS_COUNT];
...
* @{
*/
void DownMixer_UABH_A_SetCapCFNext(CyUAB_cap_enum nextCapC,
    CyUAB_f_cap_enum nextCapF);
/*! Maps gain ratio to appropriate capacitance function parameters */
#define DownMixer_UABH_A_SetPGAGain(NUMERATOR,DENOMINATOR) \
...
#define DownMixer_UABH_A_SetAttenBypassSwitchB(clk) DownMixer_UABH_A_SetSwitch(CyUAB_SW_TB,(clk))
/*! Select C branch attenuation bypass switch waveform */
#define DownMixer_UABH_A_SetAttenBypassSwitchC(clk) DownMixer_UABH_A_SetSwitch(CyUAB_SW_TC,(clk))

/*! Select Comparator flip-flop clock */
#define DownMixer_UABH_A_SetCompoutFFClock(clk) DownMixer_UABH_A_SetSwitch(CyUAB_SW_CMP_FF,(clk))
/*! Select VALID waveform */
#define DownMixer_UABH_A_SetValidClock(clk)     DownMixer_UABH_A_SetSwitch(CyUAB_SW_VALID, (clk))
/*! Select Output trigger waveform */
#define DownMixer_UABH_A_SetTrigClock(clk)      DownMixer_UABH_A_SetSwitch(CyUAB_SW_TRIG_OUT,  (clk))

/*! Strobe anytime */
#define DownMixer_UABH_A_STROBE_UPDATE_ANYTIME DownMixer_UABH_A_DYNAMIC_SWITCH_CLOSED
/*! Select strobe waveform */
#define DownMixer_UABH_A_SetStrobeClock(clk)    DownMixer_UABH_A_SetSwitch(CyUAB_SW_STROBE_RST,(clk))
...
#define DownMixer_UABH_A_EnableClocks()  DownMixer_UABH_A_Run(1UL)
/*! Disable clocking of UAB half */
#define DownMixer_UABH_A_DisableClocks() DownMixer_UABH_A_Run(0UL)
...
#define DownMixer_UABH_A_ClearAllClocks() CyUAB_wordset(\
    (DownMixer_UABH_A_SRAM0_PTR), \
    0UL,\
...
#define DownMixer_UABH_A_SetClock(phi,pattern,modbitPattern)  \
  CyUAB_SetClock(DownMixer_UABH_A_SRAM0_PTR,(phi),(pattern),(modbitPattern))

/*! Set multiple steps for all clocks 
@param len number of steps
@param stepArray array of steps */
#define DownMixer_UABH_A_SetNSteps(len,stepArray)  \
  CyUAB_SetNSteps(DownMixer_UABH_A_SRAM0_PTR,(len),(stepArray))

/*! Set single step for all clocks
@param idx index of step to write
@param stepVal value of step */
#define DownMixer_UABH_A_SetSingleStep(idx,stepVal)  \
  CyUAB_SetSingleStep(DownMixer_UABH_A_SRAM0_PTR,(idx),(stepVal))
...
#endif /* #if !defined(DownMixer_UABH_A_H) */
