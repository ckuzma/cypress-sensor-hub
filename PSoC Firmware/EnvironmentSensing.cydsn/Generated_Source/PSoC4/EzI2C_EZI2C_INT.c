                ...
                #endif /* (EzI2C_SECONDARY_ADDRESS_ENABLE_CONST) */
                    {
                        ...
                        case EzI2C_EZI2C_FSM_BYTE_WRITE:
                            if(0u != locBufSize)
                            {
                                ...
                                EzI2C_dataBuffer[locIndex] = (uint8) locByte;
                                locIndex++;
                                locBufSize--;
                            }
                            else
                        ...
                        case EzI2C_EZI2C_FSM_OFFSET_LO8:
                            ...
                            if(locByte < (uint32) EzI2C_bufSizeBuf)
                            {
                                EzI2C_I2C_SLAVE_GENERATE_ACK;
                                ...
                                locBufSize = (uint16) ((locByte < EzI2C_protectBuf) ?
                                                       (EzI2C_protectBuf - locByte) : (0u));
                ...
                else if (0u != (EzI2C_I2C_CTRL_REG & EzI2C_I2C_CTRL_S_READY_DATA_ACK))
                {
                    ...
                    */
                    ...
                    for(; (0u != fifoIndex); fifoIndex--)
                    {
                        ...
                        EzI2C_dataBuffer[locIndex] = (uint8) EzI2C_RX_FIFO_RD_REG;
                        locIndex++;
                    }
                ...
                if(0u != (locIntrSlave & EzI2C_INTR_SLAVE_I2C_ADDR_MATCH))
                {
                ...
                #endif /* (EzI2C_SECONDARY_ADDRESS_ENABLE_CONST) */
                    {
                        ...
                        if(EzI2C_CHECK_I2C_STATUS(EzI2C_I2C_STATUS_S_READ))
                        {
                            ...
                            locBufSize = EzI2C_bufSizeBuf - (uint16) locIndex;
            ...
            */
            if(0u != (EzI2C_GetInterruptCause() & EzI2C_INTR_CAUSE_TX))
            {
                ...
                do
                {
                    ...
                    if(0u != locBufSize)
                    {
                        EzI2C_TX_FIFO_WR_REG = (uint32) EzI2C_dataBuffer[locIndex];
                        locIndex++;
                        locBufSize--;
                    }
                    else
