...
#define Rectifier_UABH_B_MIN(x, y)  ( ((x)>(y))? (y) : (x) )

/*(0x00001fffUL)*/
#define CyUAB_DAC_NEXT_MASK   (Rectifier_UABH_B_SIGN_VAL_MASK | Rectifier_UABH_B_CA_VAL_MASK | Rectifier_UABH_B_CB_VAL_MASK)
#define CyUAB_DAC_NEXT_SHIFT  (Rectifier_UABH_B_CB_VAL_SHIFT)
    
/*(0x00000fffUL)*/
#define CyUAB_CF_NEXT_MASK    (Rectifier_UABH_B_CF_VAL_MASK | Rectifier_UABH_B_CC_VAL_MASK)
...
#define CyUAB_SRAM_OFFSET  ( ((uint32)Rectifier_UABH_B_SRAM0_PTR) - ((uint32)Rectifier_UABH_B_BASE_ADDR) )
